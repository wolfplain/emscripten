...
var LibraryGLUT = {
  ...
  $GLUT: {
    ...
    onMousemove: function(event) {
      ...
      if (GLUT.buttons == 0 && event.target == Module["canvas"] && GLUT.passiveMotionFunc) {
        ...
        tableCall(GLUT.passiveMotionFunc, lastX, lastY);
      } else if (GLUT.buttons != 0 && GLUT.motionFunc) {
        event.preventDefault();
        GLUT.saveModifiers(event);
        tableCall(GLUT.motionFunc, lastX, lastY);
      }
    },
      ...
      if (GLUT.specialFunc || GLUT.keyboardFunc) {
        ...
        if (key !== null) {
          if( GLUT.specialFunc ) {
            event.preventDefault();
            GLUT.saveModifiers(event);
            tableCall(GLUT.specialFunc, key, Browser.mouseX, Browser.mouseY);
          }
        }
        else
        {
          ...
          if( key !== null && GLUT.keyboardFunc ) {
            event.preventDefault();
            GLUT.saveModifiers(event);
            tableCall(GLUT.keyboardFunc, key, Browser.mouseX, Browser.mouseY);
          }
        }
      }
    },
      ...
      if (GLUT.specialUpFunc || GLUT.keyboardUpFunc) {
        ...
        if (key !== null) {
          if(GLUT.specialUpFunc) {
            event.preventDefault ();
            GLUT.saveModifiers(event);
            tableCall(GLUT.specialUpFunc, key, Browser.mouseX, Browser.mouseY);
          }
        }
        else
        {
          ...
          if( key !== null && GLUT.keyboardUpFunc ) {
            event.preventDefault ();
            GLUT.saveModifiers(event);
            tableCall(GLUT.keyboardUpFunc, key, Browser.mouseX, Browser.mouseY);
          }
        }
      }
    },
    ...
    onMouseButtonDown: function(event) {
      ...
      if (event.target == Module["canvas"] && GLUT.mouseFunc) {
        ...
        event.preventDefault();
        GLUT.saveModifiers(event);
        tableCall(GLUT.mouseFunc, event['button'], 0/*GLUT_DOWN*/, Browser.mouseX, Browser.mouseY);
      }
    },
    ...
    onMouseButtonUp: function(event) {
      ...
      if (GLUT.mouseFunc) {
        event.preventDefault();
        GLUT.saveModifiers(event);
        tableCall(GLUT.mouseFunc, event['button'], 1/*GLUT_UP*/, Browser.mouseX, Browser.mouseY);
      }
    },
    ...
    onMouseWheel: function(event) {
      ...
      if (GLUT.mouseFunc) {
        event.preventDefault();
        GLUT.saveModifiers(event);
        tableCall(GLUT.mouseFunc, button, 0/*GLUT_DOWN*/, Browser.mouseX, Browser.mouseY);
      }
    },
    ...
    onFullscreenEventChange: function(event) {
      ...
      if (GLUT.reshapeFunc) {
        ...
        tableCall(GLUT.reshapeFunc, width, height);
      }
      _glutPostRedisplay();
    }
  },
  ...
  glutTimerFunc: function(msec, func, value) {
    Browser.safeSetTimeout(function() { tableCall(func, value); }, msec);
  },
