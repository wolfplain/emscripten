...
*/
...
#endif
      if (tableCall(callbackfunc, eventTypeId, keyEventData, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, JSEvents.mouseEvent, userData)) e.preventDefault();
    };
  ...
  _registerWheelEventCallback: function(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) {
...
#endif
      if (tableCall(callbackfunc, eventTypeId, wheelEvent, userData)) e.preventDefault();
    };
    ...
    var mouseWheelHandlerFunc = function(ev) {
      ...
      var shouldCancel = tableCall(callbackfunc, eventTypeId, JSEvents.wheelEvent, userData);
      if (shouldCancel) {
        e.preventDefault();
      }
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, uiEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, focusEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, JSEvents.deviceOrientationEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, JSEvents.deviceMotionEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, orientationChangeEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, fullscreenChangeEvent, userData)) e.preventDefault();
    };
...
#endif
      tableCall(strategy.canvasResizedCallback, {{{ cDefine('EMSCRIPTEN_EVENT_CANVASRESIZED') }}}, 0, strategy.canvasResizedCallbackUserData);
    }
...
#endif
          tableCall(__currentFullscreenStrategy.canvasResizedCallback, {{{ cDefine('EMSCRIPTEN_EVENT_CANVASRESIZED') }}}, 0, __currentFullscreenStrategy.canvasResizedCallbackUserData);
        }
      }
    }
...
#endif
      if (tableCall(callbackfunc, eventTypeId, pointerlockChangeEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, 0, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, visibilityChangeEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, touchEvent, userData)) e.preventDefault();
    };
...
#endif
      if (tableCall(callbackfunc, eventTypeId, gamepadEvent, userData)) e.preventDefault();
    };
  ...
  _registerBeforeUnloadEventCallback: function(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString) {
    var beforeUnloadEventHandlerFunc = function(ev) {
      ...
      var confirmationMessage = tableCall(callbackfunc, eventTypeId, 0, userData);
...
#endif
      if (tableCall(callbackfunc, eventTypeId, batteryEvent, userData)) e.preventDefault();
    };
  ...
  emscripten_request_animation_frame: function(cb, userData) {
    return requestAnimationFrame(function(timeStamp) {
      tableCall(cb, timeStamp, userData);
    });
  },
  ...
  emscripten_request_animation_frame_loop: function(cb, userData) {
    function tick(timeStamp) {
      if (tableCall(cb, timeStamp, userData)) {
